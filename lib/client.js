...
/* The current-location rule: a short accent line under the leaf crumb.
   ...
   Colour is --endfield-focus, the skin's own selection family, NOT the brand yellow
   and not the accent: the same list at the top of this section already reserves the
   focus family for the flourishes (the /// marker, this rule, the baseline hairline)
   and keeps the configured accent for the active tab, so a user who re-points their
   accent does not repaint this mark. */
